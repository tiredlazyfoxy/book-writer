...
| FEAT-008 | Chapter skeleton & sketches | must | proposed |
| FEAT-009 | Chapter writing in blocks | must | proposed |
...
|---|---|---|---|
| UC-001 | Create DB + first admin | FEAT-001 | ACT-003 |
| UC-002 | Import DB to bootstrap | FEAT-001 | ACT-003 |
| UC-003 | Log in | FEAT-002 | ACT-001, ACT-002 |
| UC-004 | Log out / session expiry | FEAT-002 | ACT-001, ACT-002 |
| UC-005 | List users | FEAT-003 | ACT-001 |
| UC-006 | Create user | FEAT-003 | ACT-001 |
| UC-007 | Reset user password | FEAT-003 | ACT-001 |
| UC-008 | Change user role | FEAT-003 | ACT-001 |
| UC-009 | Disable user | FEAT-003 | ACT-001 |
| UC-010 | Register LLM server | FEAT-004 | ACT-001 |
| UC-011 | Test connection / probe models | FEAT-004 | ACT-001 |
| UC-012 | Enable models | FEAT-004 | ACT-001 |
| UC-013 | Edit / delete LLM server | FEAT-004 | ACT-001 |
| UC-014 | Designate embedding server + model | FEAT-004 | ACT-001 |
| UC-015 | View consistency report | FEAT-005 | ACT-001 |
| UC-016 | Create missing table | FEAT-005 | ACT-001 |
| UC-017 | Sync table schema | FEAT-005 | ACT-001 |
| UC-018 | Export database | FEAT-005 | ACT-001 |
| UC-019 | Import database (admin) | FEAT-005 | ACT-001 |
| UC-020 | Rebuild vector index | FEAT-005 | ACT-001 |
| UC-021 | Create a book | FEAT-006 | ACT-002 |
| UC-022 | List my books | FEAT-006 | ACT-004 |
| UC-023 | Archive a book | FEAT-006 | ACT-004 |
| UC-024 | Transfer ownership | FEAT-006 | ACT-004 |
| UC-025 | Admin reassigns ownership of a book whose owner is disabled | FEAT-006 | ACT-001 |
| UC-026 | Add a co-author | FEAT-007 | ACT-004 |
| UC-027 | Remove a co-author | FEAT-007 | ACT-004 |
| UC-028 | Set book visibility (private / public) | FEAT-007 | ACT-004 |
| UC-029 | Read a public book | FEAT-007 | ACT-006 |
| UC-030 | List books shared with me | FEAT-007 | ACT-005 |
| UC-031 | Add a chapter | FEAT-008 | ACT-004, ACT-005 |
| UC-032 | Reorder chapters | FEAT-008 | ACT-004 |
| UC-033 | Edit a chapter sketch | FEAT-008 | ACT-004, ACT-005 |
| UC-034 | Remove a planned chapter | FEAT-008 | ACT-004, ACT-005 |
| UC-035 | Open a chapter for writing | FEAT-009 | ACT-004 |
...
| UC-043 | Admin opens a book in the moderation view | FEAT-011 | ACT-001 |
| UC-044 | Quarantine a book | FEAT-011 | ACT-001 |
| UC-045 | Destroy a quarantined book | FEAT-011 | ACT-001 |
| UC-046 | Owner sees a removal notice | FEAT-011 | ACT-004 |
| UC-047 | System drafts a chapter's summary and state-note changes on close | FEAT-012 | ACT-004 |
| UC-048 | Owner reviews and approves a chapter's continuity data | FEAT-012 | ACT-004 |
| UC-049 | View the book's current state notes | FEAT-012 | ACT-004, ACT-005 |
| UC-050 | Edit state notes | FEAT-012 | ACT-004, ACT-005 |
| UC-051 | View a chapter's state-note changeset | FEAT-012 | ACT-004, ACT-005 |
| UC-052 | Reopening a chapter flags its continuity data stale | FEAT-012 | ACT-004 |
| UC-053 | Start a composition chat | FEAT-013 | ACT-004, ACT-005 |
...
| UC-064 | Run a consistency check on demand | FEAT-016 | ACT-004 |
| UC-065 | Run the consistency check when closing a fixed chapter | FEAT-016 | ACT-004 |
| UC-066 | Apply flags from consistency warnings | FEAT-016 | ACT-004 |
| UC-067 | Member raises a flag on a chapter | FEAT-016 | ACT-004, ACT-005 |
| UC-068 | Resolve a flag | FEAT-016 | ACT-004 |
| UC-069 | Create a codex entry | FEAT-017 | ACT-004, ACT-005 |
| UC-070 | Edit a codex entry | FEAT-017 | ACT-004, ACT-005 |
| UC-071 | Browse and search the codex | FEAT-017 | ACT-004, ACT-005 |
| UC-072 | Archive a codex entry | FEAT-017 | ACT-004, ACT-005 |
| UC-073 | View an entry's edit history | FEAT-017 | ACT-004, ACT-005 |
| UC-074 | Restore an entry to an earlier version | FEAT-017 | ACT-004, ACT-005 |
| UC-075 | Copy codex entries from another book | FEAT-017 | ACT-004, ACT-005 |
| UC-076 | Generate a codex entry from a composition chat | FEAT-018 | ACT-004, ACT-005 |
| UC-077 | Rewrite an existing codex entry from a composition chat | FEAT-018 | ACT-004, ACT-005 |
...
| US-032 | Member adds a chapter to the skeleton | FEAT-008 | proposed |
| US-033 | Owner reorders chapters | FEAT-008 | proposed |
| US-034 | Member edits the sketch of a planned chapter | FEAT-008 | proposed |
| US-035 | Member removes a planned chapter | FEAT-008 | proposed |
| US-036 | Owner opens a chapter for writing | FEAT-009 | proposed |
| US-037 | Only one chapter can be open at a time | FEAT-009 | proposed |
